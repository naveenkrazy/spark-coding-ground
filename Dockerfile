...
MAINTAINER Naveen Kurapati <naveen200x@gmail.com>
...
#Downloading the ftp file to get rid of spark worker auth issues in docker mode.
RUN wget -P /root/ ftp://anonymous:test@ita.ee.lbl.gov/traces/NASA_access_log_Jul95.gz
RUN start-master.sh
